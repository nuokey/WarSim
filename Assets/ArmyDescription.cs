...
{   
    ...
    public void updateDescription() {
        transform.GetChild(1).GetComponent<Text>().text = "Durability: " + System.Convert.ToString(chosenArmy.GetComponent<Army>().durability);
        transform.GetChild(2).GetComponent<Text>().text = "Damage: " + System.Convert.ToString(chosenArmy.GetComponent<Army>().damage);
